...
namespace SallesWeb.Data
{
    ...
    {
        private SallesWebContext _context;

        public SeedingService(SallesWebContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Rodrigo", "Rodrigo@gmail.com", new DateTime(1998, 4, 21), 3000.0, d1);
            Seller s2 = new Seller(2, "Caio", "Caio@gmail.com", new DateTime(1999, 8, 21), 2900.0, d2);
            Seller s3 = new Seller(3, "Amanda", "Amanda@gmail.com", new DateTime(2002, 3, 28), 2400.0, d1);
            Seller s4 = new Seller(4, "Fernanda", "Fernanda@gmail.com", new DateTime(2000, 5, 1), 2100.0, d4);
            Seller s5 = new Seller(5, "Lucas", "Lucas@gmail.com", new DateTime(1997, 6, 11), 3100.0, d3);
            Seller s6 = new Seller(6, "Vitor", "Vitor@gmail.com", new DateTime(2001, 4, 2), 2500.0, d2);
